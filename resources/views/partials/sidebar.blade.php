<ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #00CED1;" id="accordionSidebar">
    ...
    <!-- Heading -->
    <div class="sidebar-heading text-white font-bold">
        Umum
    </div>
    ...
    <li class="nav-item">
        <a class="nav-link" href="/pasien">
            <i class="fas fa-fw fa-book text-white">
    ...
    @if(auth()->check() && auth()->user()->is_superadmin === 1)
        <li class="nav-item">
            <a class="nav-link" href="/akun">
                ...
                <span class="text-white font-bold">Akun</span></a>
        </li>
    @endif
    ...
    <li class="nav-item">
        <div class="sidebar-card d-none d-lg-flex">
            ...
            <p class="text-center mb-2 text-white font-bold"><strong></strong>Klinik Kalisari Healthcare</p>
